...
if (!file.exists("data/GADM/contour_sen.rds")) {
contour_sen <- gadm(country = "Senegal", resolution = 1, level = 0, 
  ...
  # Enregistrement serveur local 
  contour_sen <- read_rds("data/GADM/contour_sen.rds")
}
...
Nous pouvons commencer avec une analyse globale où nous cherchons par exemple à connaître l'état 
des indicateurs sur une année précise. Quelle est la surface moyenne de forêt et de mangrove en 2020 au sein de chaque aire protégée ? 
